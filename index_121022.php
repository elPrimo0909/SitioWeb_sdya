...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<header class="theme-main-header"style="background: white"> <!--menu fondo--> 
				<div class="container" style="background: white" > <!--loader fondo-->
					<a href="./" class="logo float-left tran4s"><img src="images/logo5.png" width="180px" alt="Logo"></a>
						...
						<div id="main-banner-slider" class="rev_slider video-slider" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-20" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="video/drinkwinecover.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Title Goes Here" data-description="">
									<!-- MAIN IMAGE -->
									<img src="./images/climatizzazione-efficienza.jpg"  alt="image" class="rev-slidebg" data-bgparallax="3" data-bgposition="center center" data-duration="20000" data-ease="Linear.easeNone" data-kenburns="on" data-no-retina="" data-offsetend="0 0" data-offsetstart="0 0" data-rotateend="0" data-rotatestart="0" data-scaleend="100" data-scalestart="140">
									<!-- LAYERS -->
								...
								<li data-index="rs-18" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/home/slide-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Title Goes Here" data-description="">
									<!-- MAIN IMAGE -->
									<img src="images/air-conditioner-1185041_1920-1024x678.jpg"  alt="image" class="rev-slidebg" data-bgparallax="3" data-bgposition="center center" data-duration="20000" data-ease="Linear.easeNone" data-kenburns="on" data-no-retina="" data-offsetend="0 0" data-offsetstart="0 0" data-rotateend="0" data-rotatestart="0" data-scaleend="100" data-scalestart="140">
									<!-- LAYERS -->
			...
			<section id="about-us">
				<div class="container">
					<div class="theme-title">
						<h2>Somos...</h2>
						<p>Una empresa dedicada al servicio de Ingeniería, diseño, reparacion, venta e instalación de sistemas de aire acondicionado, ductería, sistemas de ventilación, extracción y electromecanica en general. Contamos con 10 años de experiencia prestando servicio tecnico de calidad. Prestamos nuestros servicios en los sectores hotelero, residencial, hospitalario, comercial e industrial.  Contamos con una amplia experiencia en aire  calificado para laboratorios.
</p>
					</div> <!-- /.theme-title -->
			...
			<div id="service-section">
				<div class="container">
					<div class="theme-title">
						<h2>SERVICIOS</h2>
						<p>Servicios Ductos Y Aires S.A.S. cuenta con un equipo de técnicos e ingenieros capacitado y especializado, para prestar servicio en todas las líneas de su portafolio, con la calidad y el respaldo que nuestros clientes requieren.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">DISEÑO DE SISTEMAS DE AIRE ACONDICIONADO</a></h6>
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">VENTA E INSTALACION DE AIRES ACONDICIONADOS</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">FABRICACION, VENTA E INSTALACION DE DUCTOS</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">INSTALACION DE REDES DE AIRE COMPRIMIDO</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">PLANES DE MANTENIMIENTO PREVENTIVO</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">INSTALACIONES ELECTRICAS DOMICILIARIAS</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									<div class="icon tran3s"><i class="fa fa-line-chart" aria-hidden="true"></i></div>
									<h6><a href="#" class="tran3s">SERVICIO TECNICO ELECTROMECANICO</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									<div class="icon tran3s"><i class="fa fa-life-ring" aria-hidden="true"></i></div>
									<h6><a href="#" class="tran3s">REPARACION DE SISTEMAS DE VENTILACION Y REFRIGERACION.</a></h6>
								</div>
								<p>Lorem ipsum dolor sit amet, consectetur scing elit, sed do eiusmod, tempor incididunt labore et dolore magna aliqua. Ut enim ad minim ut veniam, quis nostrud exercitation ullamco aliquip ex ea commodo consequat. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
			...
			<div id="partner-section">
				<div class="container">
					<div id="partner_logo" class="owl-carousel owl-theme"  style="background: white">
						<div class="item"><img src="images/logosmarcas1.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas2.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas3.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas4.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas5.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas6.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas7.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas8.png" alt="logo"></div>
						<div class="item"><img src="images/logosmarcas9.png" alt="logo"></div>
